...
class Ui_CycleDetection(object):
    def setupUi(self, CycleDetection):
        ...
        self.table = QtWidgets.QTableWidget(parent=CycleDetection)
        ...
        self.okButton = QtWidgets.QPushButton(parent=CycleDetection)
        self.okButton.setObjectName("okButton")
        self.horizontalLayout.addWidget(self.okButton)
        self.cancelButton = QtWidgets.QPushButton(parent=CycleDetection)
