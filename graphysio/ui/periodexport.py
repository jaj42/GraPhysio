...
class Ui_PeriodExport(object):
    def setupUi(self, PeriodExport):
        ...
        self.groupBox = QtWidgets.QGroupBox(parent=PeriodExport)
        self.groupBox.setObjectName("groupBox")
        self.formLayout_3 = QtWidgets.QFormLayout(self.groupBox)
        self.formLayout_3.setObjectName("formLayout_3")
        self.btnBrowse = QtWidgets.QPushButton(parent=self.groupBox)
        self.btnBrowse.setObjectName("btnBrowse")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.btnBrowse)
        self.txtFile = QtWidgets.QLineEdit(parent=self.groupBox)
        self.txtFile.setObjectName("txtFile")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.txtFile)
        self.verticalLayout.addWidget(self.groupBox)
        self.groupBox_2 = QtWidgets.QGroupBox(parent=PeriodExport)
        self.groupBox_2.setObjectName("groupBox_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.groupBox_2)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblPeriodStart = QtWidgets.QLabel(parent=self.groupBox_2)
        ...
        self.lblPeriodStart.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.lblPeriodStop = QtWidgets.QLabel(parent=self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblPeriodStop.sizePolicy().hasHeightForWidth())
        self.lblPeriodStop.setSizePolicy(sizePolicy)
        self.lblPeriodStop.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.label = QtWidgets.QLabel(parent=PeriodExport)
        self.label.setObjectName("label")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label)
        self.txtPatient = QtWidgets.QLineEdit(parent=PeriodExport)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.txtPatient)
        self.label_7 = QtWidgets.QLabel(parent=PeriodExport)
        self.label_7.setObjectName("label_7")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_7)
        self.txtPeriod = QtWidgets.QComboBox(parent=PeriodExport)
        ...
        self.txtPeriod.addItem("")
        self.txtPeriod.addItem("")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.txtPeriod)
        self.label_2 = QtWidgets.QLabel(parent=PeriodExport)
        self.label_2.setObjectName("label_2")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_2)
        self.txtComment = QtWidgets.QLineEdit(parent=PeriodExport)
        self.txtComment.setObjectName("txtComment")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.txtComment)
        self.verticalLayout.addLayout(self.formLayout)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.btnOk = QtWidgets.QPushButton(parent=PeriodExport)
        self.btnOk.setObjectName("btnOk")
        self.horizontalLayout_3.addWidget(self.btnOk)
        self.btnCancel = QtWidgets.QPushButton(parent=PeriodExport)
