...
class Ui_NewPlot(object):
    def setupUi(self, NewPlot):
        ...
        self.verticalLayout_2.addWidget(self.lstVX)
        ...
        self.btnRemoveY = QtWidgets.QPushButton(NewPlot)
        ...
        self.btnRemoveX = QtWidgets.QPushButton(NewPlot)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, NewPlot):
        ...
        self.groupBox_5.setTitle(_translate("NewPlot", "Series on Y axis"))
        self.groupBox_6.setTitle(_translate("NewPlot", "Series on X axis"))
