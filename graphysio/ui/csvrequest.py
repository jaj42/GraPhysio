...
class Ui_NewPlot(object):
    def setupUi(self, NewPlot):
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lblFilename)
        self.lblFolder = QtWidgets.QLabel(self.groupBox)
        self.lblFolder.setObjectName("lblFolder")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lblFolder)
    ...
    def retranslateUi(self, NewPlot):
        ...
        self.label_6.setText(_translate("NewPlot", "File"))
        self.label_8.setText(_translate("NewPlot", "Folder"))
        self.lblFilename.setText(_translate("NewPlot", "TextLabel"))
        self.lblFolder.setText(_translate("NewPlot", "TextLabel"))
