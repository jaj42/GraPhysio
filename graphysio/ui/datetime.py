...
class Ui_SetDateTime(object):
    def setupUi(self, SetDateTime):
        ...
        self.widgetCalendar = QtWidgets.QCalendarWidget(parent=SetDateTime)
        self.widgetCalendar.setFirstDayOfWeek(QtCore.Qt.DayOfWeek.Monday)
        ...
        self.edDate = QtWidgets.QDateEdit(parent=SetDateTime)
        self.edDate.setObjectName("edDate")
        self.gridLayout.addWidget(self.edDate, 1, 2, 1, 1)
        self.edTime = QtWidgets.QTimeEdit(parent=SetDateTime)
        self.edTime.setObjectName("edTime")
        self.gridLayout.addWidget(self.edTime, 2, 2, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=SetDateTime)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 2, 0, 1, 1)
        self.label = QtWidgets.QLabel(parent=SetDateTime)
        ...
        self.btnOk = QtWidgets.QPushButton(parent=SetDateTime)
        ...
        self.btnCancel = QtWidgets.QPushButton(parent=SetDateTime)
        ...
        self.widgetCalendar.clicked['QDate'].connect(self.edDate.setDate) # type: ignore
